...
const alchemyWeb3 = createAlchemyWeb3(
  'https://eth-mainnet.alchemyapi.io/v2/MCkqdWaXvnh1tne6CEG6NXYQEhgA_B9Q'
)
export const getNFT = async (contract: string, id: string) => {
  const nfts = await alchemyWeb3.alchemy.getNftMetadata({
